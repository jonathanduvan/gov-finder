...
import type { Official as OfficialType } from "../shared/types/official.js";
...
const officialSchema = new Schema<OfficialType>(
  {
...
export default model<OfficialType>("Official", officialSchema);